...
const fr: Translations = {
  ...
  investorPage: {
    meta: {
      title: "Aumentia — Investisseurs · Levée de fonds €1M–€2M",
      description: "Aumentia lève 1 à 2M€ pour construire le système d'exécution opérationnelle de référence des PME en Europe. Découvrez la thèse, les projections et le business model.",
    },
    hero: {
      badge: "🤝 INVESTISSEURS",
      h1: "Aumentia lève €1M – €2M.",
      h1accent: "Pour construire le système d'exécution de référence des PME en Europe.",
      subtitle: "On ne finance pas une vision. On accélère une machine à exécuter déjà en mouvement.",
      cta_primary: "Demander le pitch deck →",
      cta_secondary: "Voir les projections",
    },
    metrics: [
      { value: "€120B+", label: "TAM global PME IA", sub: "Marché total adressable" },
      { value: "€18B", label: "SAM Europe", sub: "Marché adressable serviceable" },
      { value: "€1B+", label: "SOM Belgique · FR · IT", sub: "Marché obtainable" },
      { value: "50–150K€", label: "LTV client estimée", sub: "Lifetime value par client" },
      { value: "7.500€", label: "Ticket Scale Sprint", sub: "Prix d'entrée unique" },
      { value: "1.500–3K€/mois", label: "Run MRR cible", sub: "Récurrent mensuel" },
    ],
    why: {
      badge: "THÈSE D'INVESTISSEMENT",
      title: "Le bon problème. Le bon moment. La bonne équipe.",
      problem_title: "Le problème",
      problem_items: [
        "72% des PME adoptent l'IA (McKinsey 2024)",
        "Seulement 12% en tirent un ROI réel (PwC)",
        "Le gap = absence de structure d'exécution",
        "C'est exactement ce qu'Aumentia fournit",
      ],
      advantage_title: "L'avantage concurrentiel",
      advantage_items: [
        "Pas du conseil (trop cher pour les PME)",
        "Pas des outils IA isolés (pas de ROI seuls)",
        "Un système d'exécution terrain clé-en-main",
        "Sprint → Run MRR → LTV 50–150K€",
      ],
    },
    model: {
      badge: "BUSINESS MODEL",
      title: "Un modèle récurrent construit sur l'exécution.",
      steps: [
        { num: "01", name: "Scale Sprint", price: "7.500€", label: "Porte d'entrée · Paiement unique" },
        { num: "02", name: "Aumentia OS Run", price: "1.500–3.000€/mois", label: "MRR récurrent · Accompagnement continu" },
        { num: "03", name: "Lifetime Value", price: "50–150K€", label: "Par client · Sur 3–5 ans" },
      ],
    },
    projections: {
      badge: "PROJECTIONS",
      title: "Une croissance ancrée dans l'exécution.",
      subtitle: "Modèle conservateur basé sur les taux de conversion actuels.",
      col_year: "Année",
      col_revenue: "Revenus",
      col_hypothesis: "Hypothèses",
      rows: [
        { year: "An 1", revenue: "300K€", hypothesis: "10 Sprints + 5 Run MRR" },
        { year: "An 2", revenue: "1M€", hypothesis: "35 Sprints + 20 Run + France / Italie" },
        { year: "An 3", revenue: "3M+€", hypothesis: "Équipe Sales/Tech + franchise modèle" },
      ],
      note: "Modèle basé sur Sprint 7.500€ + Run MRR 1.500–3.000€/mois + Upsell services",
    },
    funds: {
      badge: "USE OF FUNDS",
      title: "Chaque euro alloué à la croissance.",
      items: [
        { pct: "40%", title: "Produit & IA", desc: "Engineering · Automatisations · Scalabilité de la plateforme" },
        { pct: "30%", title: "Sales & Marketing", desc: "Growth · Content · Outreach PME France / Belgique / Italie" },
        { pct: "20%", title: "Recrutement", desc: "Ops Manager · Sales Rep · AI Engineer" },
        { pct: "10%", title: "Opérations", desc: "Infrastructure · Legal · Compliance" },
      ],
    },
    team: {
      badge: "L'ÉQUIPE",
      title: "Construits pour exécuter.",
      members: [
        {
          name: "Alexandre Gagliano",
          role: "CEO & Fondateur",
          bio: "Coach certifié Scaling Up (Gazelles · Verne Harnish). 200+ dirigeants accompagnés. Trilingue FR/EN/IT. BHAG : aider 1M de dirigeants à piloter leur croissance avec clarté d'ici 2040.",
        },
        {
          name: "Remco Lafeber",
          role: "Advisor & Partner",
          bio: "Expert en développement business et stratégie de croissance. Réseau investisseurs et scale-ups européens.",
        },
        {
          name: "Nina Barette",
          role: "Advisor & Partner",
          bio: "Expertise en marketing digital et acquisition PME. Stratégie de contenu et brand building.",
        },
      ],
    },
    cta: {
      title: "Vous investissez dans les PME de demain ?",
      subtitle: "30 minutes. On vous présente la thèse complète, les projections détaillées et le pipeline actuel.",
      btn: "Demander un rendez-vous →",
      contact: "alex@aumentia.ai · +32 471 662 563",
    },
    modal: {
      title: "Demander le pitch deck",
      subtitle: "On vous envoie le deck complet + les projections détaillées sous 24h.",
      firstname: "Prénom",
      lastname: "Nom",
      email: "Email professionnel",
      company: "Société / Fonds",
      ticket: "Ticket d'investissement habituel",
      ticket_options: ["<100K€", "100K€ – 500K€", "500K€ – 2M€", "2M€+"],
      message: "Message (optionnel)",
      message_placeholder: "Votre contexte, questions, ou intérêts particuliers...",
      submit: "Envoyer ma demande →",
      sending: "Envoi en cours…",
      success: "Demande reçue !",
      success_sub: "Alexandre vous enverra le pitch deck complet sous 24h.",
    },
  },
