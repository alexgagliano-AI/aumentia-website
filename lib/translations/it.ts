...
const it: Translations = {
  ...
  diagnostic: {
    badge: "Diagnostico IA gratuito",
    title: "Non ancora pronto per lo Sprint?",
    titleAccent: "Inizia con il diagnostico.",
    subtitle: "Richiedi il tuo diagnostico IA personalizzato. Analizziamo la tua situazione e ti ricontatteremo con un piano chiaro — senza impegno.",
    form: {
      name: "Il tuo nome",
      ...
      submit: "Richiedi il mio diagnostico gratuito →",
      sending: "Invio in corso…",
      success: "Richiesta ricevuta!",
      successSub: "Alexandre ti contatterà entro 24h per avviare il tuo diagnostico.",
    },
  },
  finalcta: {
