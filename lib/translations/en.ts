...
const en: Translations = {
  ...
  diagnostic: {
    ...
    titleAccent: "Start with the diagnostic.",
    subtitle: "Request your personalized AI diagnostic. We analyze your situation and come back to you with a clear plan — no commitment.",
    form: {
      name: "Your name",
      ...
      submit: "Request my free diagnostic →",
      sending: "Sending…",
      success: "Request received!",
      successSub: "Alexandre will contact you within 24h to launch your diagnostic.",
    },
  },
  finalcta: {
